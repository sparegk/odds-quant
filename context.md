...
Arbitrage and strategy backtesting remain unimplemented. Synthetic history validates software behavior only and no model performance or profitability result is claimed.
