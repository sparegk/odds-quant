...
describe('ModelPerformance', () => {
  ...
  it('compares Poisson with chronological Elo and other independent baselines', () => {
    ...
    expect(screen.getAllByText('BEAT')).toHaveLength(3)
    expect(screen.getByText(/Dixon–Coles and Elo are replayed only from results known before each forecast cutoff/)).toBeInTheDocument()
  })
})
