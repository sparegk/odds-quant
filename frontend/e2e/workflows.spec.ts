...
async function mockApi(page: Page) {
  await page.route('http://127.0.0.1:8000/api/v1/**', async (route) => {
    ...
    if (path === '/api/v1/data/coverage') return json(route, { minimum_evaluation_results: 200, required_bookmakers: ['Allwyn / Pamestoixima', 'Novibet', 'bet365'], total_events: 1, permitted_events: 1, permitted_final_results: 20, permitted_odds_snapshots: 1, permitted_closing_snapshots: 0, competitions: [{ competition_id: 3, competition: 'Test League', country: 'GB', season: '2025/26', total_events: 1, permitted_events: 1, permitted_teams: 2, permitted_final_results: 20, permitted_odds_snapshots: 1, permitted_closing_snapshots: 0, covered_required_bookmakers: ['bet365'], missing_required_bookmakers: ['Allwyn / Pamestoixima', 'Novibet'], first_result_kickoff_at: '2026-01-01T12:00:00Z', last_result_kickoff_at: now, closing_event_coverage: 0, evaluation_ready: false, blockers: ['fewer_than_200_final_results', 'no_closing_prices', 'missing_required_bookmakers'] }] })
