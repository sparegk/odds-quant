...
python -m app.cli audit-pamestoixima-edge-coverage --fail-on-blockers
```
...
See [context.md](context.md), [ARCHITECTURE.md](ARCHITECTURE.md), [METHODOLOGY.md](METHODOLOGY.md), [ROADMAP.md](ROADMAP.md), [DATA_IMPORTS.md](DATA_IMPORTS.md), [RESUME.md](RESUME.md), and [AGENTS.md](AGENTS.md) for detailed decisions, the current handoff, and operating rules.
